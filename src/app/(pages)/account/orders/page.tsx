...
export default async function Orders() {
  ...
  return (
    <div className="flex flex-col max-w-[520px] w-full px-4">
      <h5 className="mb-6 text-h4 text-brand-dark leading-headingLH2">My Orders</h5>
              ...
              <Link className={classes.item} href={`/account/orders/${order.id}`}>
                <div className={classes.itemContent}>
                  ...
                  <div className={classes.itemMeta}>
                    <p className={'lg:text-b16 text-b14 text-brand-dark'}>
                      {'Total: '}
